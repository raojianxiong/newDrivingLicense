 ...
 */
public class TestMisFragment extends Fragment implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        if (sb.toString().equals(webContent.getAnswerTrue())){
            //先不自动跳转下个页面
            explain.setText("正确");
            getActivity().sendBroadcast(new Intent("update_question"));
        }else{
            explain.setText(webContent.getExplain());
            myexplain.setText(webContent.getMyExplain());
        }
